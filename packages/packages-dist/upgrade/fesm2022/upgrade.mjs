...
import { U as UpgradeHelper, $ as $SCOPE, t as trustedHTMLFromLegacyTemplate, i as isFunction, s as strictEquals, d as downgradeComponent, o as onError, b as bootstrap, e as element, c as controllerKey, I as INJECTOR_KEY, a as $INJECTOR, f as downgradeInjectable, m as module_, D as Deferred, g as UPGRADE_APP_TYPE_KEY, L as LAZY_MODULE_REF, N as NG_ZONE_KEY, C as COMPILER_KEY, h as $ROOT_SCOPE, j as $$TESTABILITY, k as $COMPILE, l as destroyApp } from './upgrade_helper-05369591.mjs';
export { V as VERSION } from './upgrade_helper-05369591.mjs';
...
class UpgradeNg1ComponentAdapter {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.0.0-next.1+sha-639c717", ngImport: i0, type: UpgradeNg1ComponentAdapter, deps: "invalid", target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.0.0-next.1+sha-639c717", type: UpgradeNg1ComponentAdapter, isStandalone: true, usesOnChanges: true, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0-next.1+sha-639c717", ngImport: i0, type: UpgradeNg1ComponentAdapter, decorators: [{
            type: Directive
