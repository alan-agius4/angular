...
var factory = (tsModule) => {
  ...
  return {
    ...
    getExternalFiles(project) {
      var _a, _b;
      return (_b =
        (_a = plugin == null ? void 0 : plugin.getExternalFiles) == null
          ? void 0
          : _a.call(plugin, project, tsModule.typescript.ProgramUpdateLevel.Full)) != null
        ? _b
        : [];
    },
    onConfigurationChanged(config) {
      var _a;
      (_a = plugin == null ? void 0 : plugin.onConfigurationChanged) == null
        ? void 0
        : _a.call(plugin, config);
    },
  };
};
/**
