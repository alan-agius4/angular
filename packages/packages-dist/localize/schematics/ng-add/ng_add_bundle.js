  ...
  return (host) =>
    __async(this, null, function* () {
      ...
      for (const target of project.targets.values()) {
        ...
        if (
          target.builder === import_utility.AngularBuilder.Browser ||
          target.builder === import_utility.AngularBuilder.BrowserEsbuild
        ) {
...
function moveToDependencies(host) {
  ...
  return (0, import_utility.addDependency)('@angular/localize', `~20.0.0-next.1+sha-639c717`);
}
