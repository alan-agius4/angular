...
var MessageExtractor = class {
  ...
  getOriginalLocation(sourceFile, location) {
    ...
    const originalSourceFile = sourceFile.sources.find(
      (sf) => (sf == null ? void 0 : sf.sourcePath) === originalStart.file,
    );
...
var Xliff1TranslationSerializer = class {
  ...
  serializeMessage(xml, message) {
    ...
    for (let i = 0; i < length; i++) {
      ...
      this.serializePlaceholder(
        xml,
        name,
        location == null ? void 0 : location.text,
        associatedMessageId,
      );
    }
  ...
  serializeLocation(xml, location) {
    ...
    const endLineString =
      location.end !== void 0 && location.end.line !== location.start.line
        ? `,${location.end.line + 1}`
        : '';
...
var Xliff2TranslationSerializer = class {
  ...
  serializePlaceholder(xml, placeholderName, substitutionLocations, associatedMessageId) {
    var _a, _b;
    const text =
      (_a = substitutionLocations == null ? void 0 : substitutionLocations[placeholderName]) == null
        ? void 0
        : _a.text;
    if (placeholderName.startsWith('START_')) {
      ...
      const closingText =
        (_b =
          substitutionLocations == null ? void 0 : substitutionLocations[closingPlaceholderName]) ==
        null
          ? void 0
          : _b.text;
      const attrs = {
