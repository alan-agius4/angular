...
(function (ErrorCode2) {
  ...
  ErrorCode2[(ErrorCode2['INITIALIZER_API_WITH_DISALLOWED_DECORATOR'] = 1050)] =
    'INITIALIZER_API_WITH_DISALLOWED_DECORATOR';
  ErrorCode2[(ErrorCode2['INITIALIZER_API_DECORATOR_METADATA_COLLISION'] = 1051)] =
    'INITIALIZER_API_DECORATOR_METADATA_COLLISION';
  ErrorCode2[(ErrorCode2['INITIALIZER_API_NO_REQUIRED_FUNCTION'] = 1052)] =
    'INITIALIZER_API_NO_REQUIRED_FUNCTION';
  ErrorCode2[(ErrorCode2['INITIALIZER_API_DISALLOWED_MEMBER_VISIBILITY'] = 1053)] =
    'INITIALIZER_API_DISALLOWED_MEMBER_VISIBILITY';
  ErrorCode2[(ErrorCode2['INCORRECTLY_DECLARED_ON_STATIC_MEMBER'] = 1100)] =
  ...
  ErrorCode2[(ErrorCode2['DIRECTIVE_INHERITS_UNDECORATED_CTOR'] = 2006)] =
    'DIRECTIVE_INHERITS_UNDECORATED_CTOR';
  ErrorCode2[(ErrorCode2['UNDECORATED_CLASS_USING_ANGULAR_FEATURES'] = 2007)] =
  ...
  ErrorCode2[(ErrorCode2['COMPONENT_INVALID_SHADOW_DOM_SELECTOR'] = 2009)] =
    'COMPONENT_INVALID_SHADOW_DOM_SELECTOR';
  ErrorCode2[(ErrorCode2['COMPONENT_NOT_STANDALONE'] = 2010)] = 'COMPONENT_NOT_STANDALONE';
  ErrorCode2[(ErrorCode2['COMPONENT_IMPORT_NOT_STANDALONE'] = 2011)] =
  ...
  ErrorCode2[(ErrorCode2['HOST_DIRECTIVE_NOT_STANDALONE'] = 2014)] =
    'HOST_DIRECTIVE_NOT_STANDALONE';
  ErrorCode2[(ErrorCode2['HOST_DIRECTIVE_COMPONENT'] = 2015)] = 'HOST_DIRECTIVE_COMPONENT';
  ErrorCode2[(ErrorCode2['INJECTABLE_INHERITS_INVALID_CONSTRUCTOR'] = 2016)] =
    'INJECTABLE_INHERITS_INVALID_CONSTRUCTOR';
  ErrorCode2[(ErrorCode2['HOST_DIRECTIVE_UNDEFINED_BINDING'] = 2017)] =
    'HOST_DIRECTIVE_UNDEFINED_BINDING';
  ErrorCode2[(ErrorCode2['HOST_DIRECTIVE_CONFLICTING_ALIAS'] = 2018)] =
    'HOST_DIRECTIVE_CONFLICTING_ALIAS';
  ErrorCode2[(ErrorCode2['HOST_DIRECTIVE_MISSING_REQUIRED_BINDING'] = 2019)] =
  ...
  ErrorCode2[(ErrorCode2['COMPONENT_UNKNOWN_DEFERRED_IMPORT'] = 2022)] =
  ...
  ErrorCode2[(ErrorCode2['CONFIG_STRICT_TEMPLATES_IMPLIES_FULL_TEMPLATE_TYPECHECK'] = 4002)] =
    'CONFIG_STRICT_TEMPLATES_IMPLIES_FULL_TEMPLATE_TYPECHECK';
  ErrorCode2[(ErrorCode2['CONFIG_EXTENDED_DIAGNOSTICS_IMPLIES_STRICT_TEMPLATES'] = 4003)] =
    'CONFIG_EXTENDED_DIAGNOSTICS_IMPLIES_STRICT_TEMPLATES';
  ErrorCode2[(ErrorCode2['CONFIG_EXTENDED_DIAGNOSTICS_UNKNOWN_CATEGORY_LABEL'] = 4004)] =
    'CONFIG_EXTENDED_DIAGNOSTICS_UNKNOWN_CATEGORY_LABEL';
  ErrorCode2[(ErrorCode2['CONFIG_EXTENDED_DIAGNOSTICS_UNKNOWN_CHECK'] = 4005)] =
  ...
  ErrorCode2[(ErrorCode2['NGMODULE_MODULE_WITH_PROVIDERS_MISSING_GENERIC'] = 6005)] =
    'NGMODULE_MODULE_WITH_PROVIDERS_MISSING_GENERIC';
  ErrorCode2[(ErrorCode2['NGMODULE_REEXPORT_NAME_COLLISION'] = 6006)] =
    'NGMODULE_REEXPORT_NAME_COLLISION';
  ErrorCode2[(ErrorCode2['NGMODULE_DECLARATION_NOT_UNIQUE'] = 6007)] =
    'NGMODULE_DECLARATION_NOT_UNIQUE';
  ErrorCode2[(ErrorCode2['NGMODULE_DECLARATION_IS_STANDALONE'] = 6008)] =
    'NGMODULE_DECLARATION_IS_STANDALONE';
  ErrorCode2[(ErrorCode2['NGMODULE_BOOTSTRAP_IS_STANDALONE'] = 6009)] =
  ...
  ErrorCode2[(ErrorCode2['DUPLICATE_VARIABLE_DECLARATION'] = 8006)] =
  ...
  ErrorCode2[(ErrorCode2['ILLEGAL_FOR_LOOP_TRACK_ACCESS'] = 8009)] =
    'ILLEGAL_FOR_LOOP_TRACK_ACCESS';
  ErrorCode2[(ErrorCode2['INACCESSIBLE_DEFERRED_TRIGGER_ELEMENT'] = 8010)] =
    'INACCESSIBLE_DEFERRED_TRIGGER_ELEMENT';
  ErrorCode2[(ErrorCode2['CONTROL_FLOW_PREVENTING_CONTENT_PROJECTION'] = 8011)] =
  ...
  ErrorCode2[(ErrorCode2['DEFERRED_DIRECTIVE_USED_EAGERLY'] = 8013)] =
    'DEFERRED_DIRECTIVE_USED_EAGERLY';
  ErrorCode2[(ErrorCode2['DEFERRED_DEPENDENCY_IMPORTED_EAGERLY'] = 8014)] =
  ...
  ErrorCode2[(ErrorCode2['NULLISH_COALESCING_NOT_NULLABLE'] = 8102)] =
    'NULLISH_COALESCING_NOT_NULLABLE';
  ErrorCode2[(ErrorCode2['MISSING_CONTROL_FLOW_DIRECTIVE'] = 8103)] =
  ...
  ErrorCode2[(ErrorCode2['INTERPOLATED_SIGNAL_NOT_INVOKED'] = 8109)] =
    'INTERPOLATED_SIGNAL_NOT_INVOKED';
  ErrorCode2[(ErrorCode2['UNSUPPORTED_INITIALIZER_API_USAGE'] = 8110)] =
    'UNSUPPORTED_INITIALIZER_API_USAGE';
  ErrorCode2[(ErrorCode2['UNINVOKED_FUNCTION_IN_EVENT_BINDING'] = 8111)] =
  ...
  ErrorCode2[(ErrorCode2['SUGGEST_SUBOPTIMAL_TYPE_INFERENCE'] = 10002)] =
    'SUGGEST_SUBOPTIMAL_TYPE_INFERENCE';
  ErrorCode2[(ErrorCode2['LOCAL_COMPILATION_UNRESOLVED_CONST'] = 11001)] =
    'LOCAL_COMPILATION_UNRESOLVED_CONST';
  ErrorCode2[(ErrorCode2['LOCAL_COMPILATION_UNSUPPORTED_EXPRESSION'] = 11003)] =
...
(function (ExtendedTemplateDiagnosticName2) {
  ...
  ExtendedTemplateDiagnosticName2['NULLISH_COALESCING_NOT_NULLABLE'] =
  ...
  ExtendedTemplateDiagnosticName2['UNINVOKED_FUNCTION_IN_EVENT_BINDING'] =
  ...
  ExtendedTemplateDiagnosticName2['INTERPOLATED_SIGNAL_NOT_INVOKED'] =
    'interpolatedSignalNotInvoked';
  ExtendedTemplateDiagnosticName2['CONTROL_FLOW_PREVENTING_CONTENT_PROJECTION'] =
...
function isDecoratorIdentifier(exp) {
  return (
    ts2.isIdentifier(exp) ||
    (ts2.isPropertyAccessExpression(exp) &&
      ts2.isIdentifier(exp.expression) &&
      ts2.isIdentifier(exp.name))
  );
}
var ClassMemberKind;
...
var TypeScriptReflectionHost = class {
  ...
  getDecoratorsOfDeclaration(declaration) {
    ...
    return decorators !== void 0 && decorators.length
      ? decorators
  ...
  getConstructorParameters(clazz) {
    ...
    const ctor = tsClazz.members.find(
      (member) =>
        ts5.isConstructorDeclaration(member) && (isDeclaration2 || member.body !== void 0),
    );
    if (ctor === void 0) {
      return null;
    }
    return ctor.parameters.map((node) => {
      ...
      if (typeNode && ts5.isUnionTypeNode(typeNode)) {
        let childTypeNodes = typeNode.types.filter(
          (childTypeNode) =>
            !(
              ts5.isLiteralTypeNode(childTypeNode) &&
              childTypeNode.literal.kind === ts5.SyntaxKind.NullKeyword
            ),
        );
  ...
  getBaseClassExpression(clazz) {
    if (
      !(ts5.isClassDeclaration(clazz) || ts5.isClassExpression(clazz)) ||
      clazz.heritageClauses === void 0
    ) {
      return null;
    }
    const extendsClause = clazz.heritageClauses.find(
      (clause) => clause.token === ts5.SyntaxKind.ExtendsKeyword,
    );
  ...
  getDefinitionOfFunction(node) {
    if (
      !ts5.isFunctionDeclaration(node) &&
      !ts5.isMethodDeclaration(node) &&
      !ts5.isFunctionExpression(node) &&
      !ts5.isArrowFunction(node)
    ) {
      return null;
    }
    let body = null;
    if (node.body !== void 0) {
      body = ts5.isBlock(node.body)
        ? Array.from(node.body.statements)
        : [ts5.factory.createReturnStatement(node.body)];
    }
  ...
  isStaticallyExported(decl) {
    ...
    if (
      modifiers !== void 0 &&
      modifiers.some((modifier) => modifier.kind === ts5.SyntaxKind.ExportKeyword)
    ) {
      return true;
    }
  ...
  getImportOfNamespacedIdentifier(id, namespaceIdentifier) {
    ...
    if (
      !ts5.isImportDeclaration(importDeclaration) ||
      !ts5.isStringLiteral(importDeclaration.moduleSpecifier)
    ) {
      return null;
    }
    return {
  ...
  _reflectDecorator(node) {
    ...
    const decoratorIdentifier = ts5.isIdentifier(decoratorExpr)
      ? decoratorExpr
      : decoratorExpr.name;
  ...
  getLocalExportedDeclarationsOfSourceFile(file) {
    ...
    while (item.done !== true) {
      ...
      if (
        exportedSymbol.valueDeclaration !== void 0 &&
...
function castDeclarationToClassOrDie(declaration) {
  if (!ts5.isClassDeclaration(declaration)) {
    throw new Error(
      `Reflecting on a ${ts5.SyntaxKind[declaration.kind]} instead of a ClassDeclaration.`,
    );
  }
  return declaration;
}
...
function isPrivateSymbol(typeChecker, symbol) {
  ...
  if (symbol.valueDeclaration !== void 0) {
    ...
    return (
      ((_a = symbolType == null ? void 0 : symbolType.symbol) == null
        ? void 0
        : _a.name.startsWith('\u0275')) === true
    );
  }
  return false;
}
...
function getExportedName(decl, originalId) {
  return ts5.isImportSpecifier(decl)
    ? (decl.propertyName !== void 0 ? decl.propertyName : decl.name).text
    : originalId.text;
}
...
function nodeNameForError(node) {
  if (node.name !== void 0 && ts6.isIdentifier(node.name)) {
    ...
    const {line, character} = ts6.getLineAndCharacterOfPosition(
      node.getSourceFile(),
      node.getStart(),
    );
...
function isValueDeclaration(node) {
  return (
    ...
    ts6.isVariableDeclaration(node)
  );
}
...
function resolveModuleName(
  ...
  if (compilerHost.resolveModuleNames) {
    ...
    return ts6.resolveModuleName(
      moduleName,
      containingFile,
      compilerOptions,
      compilerHost,
      moduleResolutionCache !== null ? moduleResolutionCache : void 0,
    ).resolvedModule;
  }
}
...
var AbsoluteModuleStrategy = class {
  ...
  emit(ref, context, importFlags) {
    if (ref.bestGuessOwningModule === null) {
      ...
      throw new Error(
        `Debug assert: unable to import a Reference to non-declaration of type ${ts7.SyntaxKind[ref.node.kind]}.`,
      );
    } else if ((importFlags & ImportFlags.AllowTypeImports) === 0 && isTypeDeclaration(ref.node)) {
      throw new Error(
        `Importing a type-only declaration of type ${ts7.SyntaxKind[ref.node.kind]} in a value position is not allowed.`,
      );
    }
...
var DeferredSymbolTracker = class {
  ...
  markAsDeferrableCandidate(identifier, importDecl, componentClassDecl, isExplicitlyDeferred) {
    ...
    if (!symbolMap.has(identifier.text)) {
      throw new Error(
        `The '${identifier.text}' identifier doesn't belong to the provided import declaration.`,
      );
    }
...
var ImportedSymbolsTracker = class {
  ...
  isPotentialReferenceToNamespaceImport(node, moduleName) {
    ...
    return (_b = (_a = namespaces.get(moduleName)) == null ? void 0 : _a.has(node.text)) != null
      ? _b
      : false;
  }
  ...
  scanImports(sourceFile) {
    ...
    for (const stmt of sourceFile.statements) {
      if (
        !ts10.isImportDeclaration(stmt) ||
        !ts10.isStringLiteralLike(stmt.moduleSpecifier) ||
        ((_a = stmt.importClause) == null ? void 0 : _a.namedBindings) === void 0
      ) {
        continue;
      }
      ...
      if (ts10.isNamespaceImport(stmt.importClause.namedBindings)) {
        ...
        for (const element of stmt.importClause.namedBindings.elements) {
          ...
          const exportedName =
            element.propertyName === void 0 ? localName : element.propertyName.text;
...
function createGenerateUniqueIdentifierHelper() {
  ...
  return (sourceFile, symbolName) => {
    ...
    const isUniqueIdentifier = (name2) =>
      !sf.identifiers.has(name2) && !isGeneratedIdentifier(sf, name2);
...
function createTsTransformForImportManager(manager, extraStatementsForFiles) {
  return (ctx) => {
    ...
    const visitStatement = (node) => {
      ...
      if (
        clause.namedBindings === void 0 ||
        !ts13.isNamedImports(clause.namedBindings) ||
    ...
    return (sourceFile) => {
      ...
      const extraStatements =
        (_a =
          extraStatementsForFiles == null
            ? void 0
            : extraStatementsForFiles.get(sourceFile.fileName)) != null
          ? _a
          : [];
...
function isImportStatement(stmt) {
  return (
    ts13.isImportDeclaration(stmt) ||
    ts13.isImportEqualsDeclaration(stmt) ||
    ts13.isNamespaceImport(stmt)
  );
}
...
function attemptToReuseExistingSourceFileImports(tracker, sourceFile, request) {
      ...
      if (ts15.isNamedImports(namedBindings) && request.exportSymbolName !== null) {
        const existingElement = namedBindings.elements.find((e) => {
          ...
          if (request.unsafeAliasOverride) {
            nameMatches =
              ((_a = e.propertyName) == null ? void 0 : _a.text) === request.exportSymbolName &&
  ...
  const fileUniqueAlias = request.unsafeAliasOverride
    ? ts15.factory.createIdentifier(request.unsafeAliasOverride)
...
var ImportManager = class {
  ...
  constructor(config = {}) {
    ...
    this.config = {
      ...
      disableOriginalSourceFileReuse:
        (_c = config.disableOriginalSourceFileReuse) != null ? _c : false,
      forceGenerateNamespacesForNewImports:
        (_d = config.forceGenerateNamespacesForNewImports) != null ? _d : false,
      namespaceImportPrefix: (_e = config.namespaceImportPrefix) != null ? _e : 'i',
      generateUniqueIdentifier:
        (_f = config.generateUniqueIdentifier) != null
          ? _f
  ...
  addImport(request) {
    ...
    if (request.exportSymbolName !== null && !request.asTypeReference) {
      (_b =
        (_a = this.removedImports.get(request.requestedFile)) == null
          ? void 0
          : _a.get(request.exportModuleSpecifier)) == null
        ? void 0
        : _b.delete(request.exportSymbolName);
    }
  ...
  _generateNewImport(request) {
    ...
    if (request.exportSymbolName === null || forceGenerateNamespacesForNewImports) {
      ...
      const namespaceImport2 = ts16.factory.createNamespaceImport(
        (_a = this.config.generateUniqueIdentifier(sourceFile, namespaceImportName)) != null
          ? _a
          : ts16.factory.createIdentifier(namespaceImportName),
      );
      namespaceImports.set(request.exportModuleSpecifier, namespaceImport2);
      captureGeneratedImport(
        {...request, exportSymbolName: null},
        this.reuseGeneratedImportsTracker,
        namespaceImport2.name,
      );
      if (request.exportSymbolName !== null) {
    ...
    namedImports
      ...
      .push(
        ts16.factory.createImportSpecifier(
          false,
          needsAlias ? exportSymbolName : void 0,
          specifierName,
        ),
      );
  ...
  finalize() {
    ...
    this.reuseSourceFileImportsTracker.updatedImports.forEach((expressions, importDecl) => {
      ...
      const newElements = namedBindings.elements
        .concat(
          expressions.map(({propertyName, fileUniqueAlias}) =>
            ts16.factory.createImportSpecifier(
              false,
              fileUniqueAlias !== null ? propertyName : void 0,
              fileUniqueAlias != null ? fileUniqueAlias : propertyName,
            ),
          ),
        )
      ...
      if (newElements.length === 0) {
        ...
        updatedImportsResult.set(
          namedBindings,
          ts16.factory.updateNamedImports(namedBindings, newElements),
        );
      }
    });
    this.removedImports.forEach((removeMap, sourceFile) => {
      ...
      for (const node of allImports) {
        if (
          !((_a = node.importClause) == null ? void 0 : _a.namedBindings) ||
          !ts16.isNamedImports(node.importClause.namedBindings) ||
        ...
        if (newImports.length === 0) {
          ...
          updatedImportsResult.set(
            namedBindings,
            ts16.factory.updateNamedImports(namedBindings, newImports),
          );
        }
      }
    });
    this.newImports.forEach(({namedImports, namespaceImports, sideEffectImports}, sourceFile) => {
      ...
      sideEffectImports.forEach((moduleName) => {
        addNewImport(
          fileName,
          ts16.factory.createImportDeclaration(
            void 0,
            void 0,
            ts16.factory.createStringLiteral(moduleName),
          ),
        );
      });
      namespaceImports.forEach((namespaceImport2, moduleName) => {
        const newImport = ts16.factory.createImportDeclaration(
          void 0,
          ts16.factory.createImportClause(false, void 0, namespaceImport2),
          ts16.factory.createStringLiteral(moduleName, useSingleQuotes),
        );
      ...
      namedImports.forEach((specifiers, moduleName) => {
        ...
        if (filteredSpecifiers.length > 0) {
          const newImport = ts16.factory.createImportDeclaration(
            void 0,
            ts16.factory.createImportClause(
              false,
              void 0,
              ts16.factory.createNamedImports(filteredSpecifiers),
            ),
            ts16.factory.createStringLiteral(moduleName, useSingleQuotes),
          );
          addNewImport(fileName, newImport);
  ...
  transformTsFile(ctx, file, extraStatementsAfterImports) {
    const extraStatementsMap = extraStatementsAfterImports
      ? /* @__PURE__ */ new Map([[file.fileName, extraStatementsAfterImports]])
      : void 0;
  ...
  _canAddSpecifier(sourceFile, moduleSpecifier, specifier) {
    var _a, _b;
    return !((_b =
      (_a = this.removedImports.get(sourceFile)) == null ? void 0 : _a.get(moduleSpecifier)) == null
      ? void 0
      : _b.has((specifier.propertyName || specifier.name).text));
  }
};
  ...
  visitDeclareVarStmt(stmt, context) {
    ...
    return this.attachComments(
      this.factory.createVariableDeclaration(
        stmt.name,
        (_a = stmt.value) == null ? void 0 : _a.visitExpression(this, context.withExpressionMode),
        varType,
      ),
...
var TypeEmitter = class {
  ...
  emitTypeReference(type) {
    ...
    if (type.typeArguments !== void 0) {
      typeArguments = ts17.factory.createNodeArray(
...
var TypeTranslatorVisitor = class {
  ...
  visitMapType(type, context) {
    const parameter = ts19.factory.createParameterDeclaration(
      void 0,
      void 0,
      'key',
      void 0,
      ts19.factory.createKeywordTypeNode(ts19.SyntaxKind.StringKeyword),
    );
    const typeArgs =
      type.valueType !== null
        ? this.translateType(type.valueType, context)
        : ts19.factory.createKeywordTypeNode(ts19.SyntaxKind.UnknownKeyword);
  ...
  visitLiteralExpr(ast, context) {
    if (ast.value === null) {
      ...
      return ts19.factory.createLiteralTypeNode(
        ast.value ? ts19.factory.createTrue() : ts19.factory.createFalse(),
      );
  ...
  visitWrappedNodeExpr(ast, context) {
    ...
    if (ts19.isEntityName(node)) {
      ...
      throw new Error(
        `Unsupported WrappedNodeExpr in TypeTranslatorVisitor: ${ts19.SyntaxKind[node.kind]}`,
      );
    }
  }
  visitTypeofExpr(ast, context) {
  ...
  translateType(type, context) {
    ...
    if (!ts19.isTypeNode(typeNode)) {
      throw new Error(
        `A Type must translate to a TypeNode, but was ${ts19.SyntaxKind[typeNode.kind]}`,
      );
    }
    return typeNode;
  }
  translateExpression(expr, context) {
    ...
    if (!ts19.isTypeNode(typeNode)) {
      throw new Error(
        `An Expression must translate to a TypeNode, but was ${ts19.SyntaxKind[typeNode.kind]}`,
      );
    }
    return typeNode;
  }
  translateTypeReference(type, context, viaModule) {
    ...
    if (!ts19.isTypeReferenceNode(typeNode)) {
      throw new Error(
        `Expected TypeReferenceNode for emitted reference, got ${ts19.SyntaxKind[typeNode.kind]}.`,
      );
    }
    return typeNode;
  }
...
var TypeScriptAstFactory = class {
  ...
  createBinaryExpression(leftOperand, operator, rightOperand) {
    return ts20.factory.createBinaryExpression(
      leftOperand,
      BINARY_OPERATORS2[operator],
      rightOperand,
    );
  }
  createBlock(body) {
  ...
  createFunctionDeclaration(functionName, parameters, body) {
    ...
    return ts20.factory.createFunctionDeclaration(
      void 0,
      void 0,
      functionName,
      void 0,
      parameters.map((param) => ts20.factory.createParameterDeclaration(void 0, void 0, param)),
      void 0,
      body,
    );
  }
  createFunctionExpression(functionName, parameters, body) {
    ...
    return ts20.factory.createFunctionExpression(
      void 0,
      void 0,
      functionName != null ? functionName : void 0,
      void 0,
      parameters.map((param) => ts20.factory.createParameterDeclaration(void 0, void 0, param)),
      void 0,
      body,
  ...
  createArrowFunctionExpression(parameters, body) {
    ...
    return ts20.factory.createArrowFunction(
      void 0,
      void 0,
      parameters.map((param) => ts20.factory.createParameterDeclaration(void 0, void 0, param)),
      void 0,
  ...
  createIfStatement(condition, thenStatement, elseStatement) {
    return ts20.factory.createIfStatement(
      condition,
      thenStatement,
      elseStatement != null ? elseStatement : void 0,
    );
  }
  createLiteral(value) {
    if (value === void 0) {
  ...
  createObjectLiteral(properties) {
    return ts20.factory.createObjectLiteralExpression(
      properties.map((prop) =>
        ts20.factory.createPropertyAssignment(
          prop.quoted
            ? ts20.factory.createStringLiteral(prop.propertyName)
            : ts20.factory.createIdentifier(prop.propertyName),
          prop.value,
        ),
      ),
    );
  ...
  createTaggedTemplate(tag, template) {
    return ts20.factory.createTaggedTemplateExpression(
      tag,
      void 0,
  ...
  createTemplateLiteral(template) {
    ...
    if (length === 1) {
      ...
      templateLiteral = ts20.factory.createTemplateExpression(
        ts20.factory.createTemplateHead(head.cooked, head.raw),
        spans,
      );
    }
    if (head.range !== null) {
  ...
  createVariableDeclaration(variableName, initializer, type) {
    return ts20.factory.createVariableStatement(
      void 0,
      ts20.factory.createVariableDeclarationList(
        [
          ts20.factory.createVariableDeclaration(
            variableName,
            void 0,
            void 0,
  ...
  setSourceMapRange(node, sourceMapRange) {
    ...
    if (!this.externalSourceFiles.has(url)) {
      this.externalSourceFiles.set(
        url,
        ts20.createSourceMapSource(url, sourceMapRange.content, (pos) => pos),
      );
    }
...
function attachComments(statement, leadingComments) {
  for (const comment of leadingComments) {
    const commentKind = comment.multiline
      ? ts20.SyntaxKind.MultiLineCommentTrivia
      : ts20.SyntaxKind.SingleLineCommentTrivia;
