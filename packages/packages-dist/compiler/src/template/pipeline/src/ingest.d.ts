 ...
 */
export declare function ingestComponent(componentName: string, template: t.Node[], constantPool: ConstantPool, relativeContextFilePath: string, i18nUseExternalIds: boolean, deferMeta: R3ComponentDeferMetadata, allDeferrableDepsFn: o.ReadVarExpr | null, relativeTemplatePath: string | null, enableDebugLocations: boolean): ComponentCompilationJob;
...
export declare function ingestHostProperty(job: HostBindingCompilationJob, property: e.ParsedProperty, bindingKind: ir.BindingKind, securityContexts: SecurityContext[]): void;
