...
import { BindingKind, DeferOpModifierKind, I18nExpressionFor, I18nParamResolutionTime, OpKind, TemplateKind } from '../enums';
 ...
 */
export type UpdateOp = ListEndOp<UpdateOp> | StatementOp<UpdateOp> | PropertyOp | TwoWayPropertyOp | AttributeOp | StylePropOp | ClassPropOp | StyleMapOp | ClassMapOp | InterpolateTextOp | AdvanceOp | VariableOp<UpdateOp> | BindingOp | HostPropertyOp | ConditionalOp | I18nExpressionOp | I18nApplyOp | RepeaterOp | DeferWhenOp | StoreLetOp;
/**
 ...
 * Create a `PropertyOp`.
 */
export declare function createPropertyOp(target: XrefId, name: string, expression: o.Expression | Interpolation, isAnimationTrigger: boolean, securityContext: SecurityContext | SecurityContext[], isStructuralTemplateAttribute: boolean, templateKind: TemplateKind | null, i18nContext: XrefId | null, i18nMessage: i18n.Message | null, sourceSpan: ParseSourceSpan): PropertyOp;
/**
