...
import { BoundAttribute, BoundEvent, Content, DeferredBlock, DeferredBlockError, DeferredBlockLoading, DeferredBlockPlaceholder, DeferredTrigger, Element, ForLoopBlock, ForLoopBlockEmpty, IfBlockBranch, LetDeclaration, Node, Reference, SwitchBlockCase, Template, TextAttribute, Variable } from '../r3_ast';
/** Node that has a `Scope` associated with it. */
export type ScopedNode = Template | SwitchBlockCase | IfBlockBranch | ForLoopBlock | ForLoopBlockEmpty | DeferredBlock | DeferredBlockError | DeferredBlockLoading | DeferredBlockPlaceholder | Content;
