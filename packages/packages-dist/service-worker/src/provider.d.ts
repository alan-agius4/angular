 ...
 */
import { EnvironmentProviders, InjectionToken, Injector } from '@angular/core';
import { Observable } from 'rxjs';
import { NgswCommChannel } from './low_level';
export declare const SCRIPT: InjectionToken<string>;
export declare function ngswAppInitializer(injector: Injector, script: string, options: SwRegistrationOptions): Function;
export declare function ngswCommChannelFactory(opts: SwRegistrationOptions): NgswCommChannel;
/**
