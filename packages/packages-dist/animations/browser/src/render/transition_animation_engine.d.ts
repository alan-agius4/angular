...
declare class AnimationTransitionNamespace {
    id: string;
    hostElement: any;
    private _engine;
...
export declare class TransitionAnimationEngine {
    ...
    statesByElement: Map<any, Map<string, StateValue>>;
    ...
    markElementAsRemoved(namespaceId: string, element: any, hasAnimation?: boolean, context?: any, previousTriggersValues?: Map<string, string>): void;
