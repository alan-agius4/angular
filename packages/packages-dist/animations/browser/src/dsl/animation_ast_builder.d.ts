...
export declare function buildAnimationAst(driver: AnimationDriver, metadata: AnimationMetadata | AnimationMetadata[], errors: Error[], warnings: string[]): Ast<AnimationMetadataType>;
export declare class AnimationAstBuilderVisitor implements AnimationDslVisitor {
    private _driver;
    constructor(_driver: AnimationDriver);
    build(metadata: AnimationMetadata | AnimationMetadata[], errors: Error[], warnings: string[]): Ast<AnimationMetadataType>;
...
export declare class AnimationAstBuilderContext {
    ...
    currentTime: number;
    collectedStyles: Map<string, Map<string, StyleTimeTuple>>;
    options: AnimationOptions | null;
    unsupportedCSSPropertiesFound: Set<string>;
