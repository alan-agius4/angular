 ...
 */
export declare const NGH_DATA_KEY: import("../transfer_state").StateKey<SerializedView[]>;
/**
 ...
 */
export declare const NGH_DEFER_BLOCKS_KEY: import("../transfer_state").StateKey<{
