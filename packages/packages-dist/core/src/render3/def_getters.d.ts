...
export declare function getNgModuleDef<T>(type: any, throwIfNotFound: true): NgModuleDef<T>;
...
export declare function getDirectiveDef<T>(type: any, throwIfNotFound: true): DirectiveDef<T>;
