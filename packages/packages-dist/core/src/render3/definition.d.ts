...
import type { ComponentDef, ComponentDefFeature, ComponentTemplate, ContentQueriesFunction, DependencyTypeList, DirectiveDef, DirectiveDefFeature, DirectiveDefListOrFactory, HostBindingsFunction, InputTransformFunction, PipeDefListOrFactory, TypeOrFactory, ViewQueriesFunction } from './interfaces/definition';
...
export declare function extractDefListOrFactory(dependencies: TypeOrFactory<DependencyTypeList> | undefined, pipeDef: false): DirectiveDefListOrFactory | null;
export declare function extractDefListOrFactory(dependencies: TypeOrFactory<DependencyTypeList> | undefined, pipeDef: true): PipeDefListOrFactory | null;
/**
