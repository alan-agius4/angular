 ...
 * within `TView.data`.
 */
export declare function isTNodeShape(value: unknown): value is TNode;
export declare function isLetDeclaration(tNode: TNode): boolean;
/**
 ...
 * ```
 */
export type DirectiveIndexMap = Map<Type<unknown>, number | [directiveIndex: number, hostDirectivesStart: number, hostDirectivesEnd: number]>;
/**
