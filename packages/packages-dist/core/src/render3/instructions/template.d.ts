...
import { LocalRefExtractor, TAttributes, TNode } from '../interfaces/node';
 ...
 */
export declare function declareTemplate(declarationLView: LView, declarationTView: TView, index: number, templateFn: ComponentTemplate<any> | null, decls: number, vars: number, tagName?: string | null, attrs?: TAttributes | null, localRefsIndex?: number | null, localRefExtractor?: LocalRefExtractor): TNode;
/**
