 ...
 */
export declare function validateElementIsKnown(element: RElement, lView: LView, tagName: string | null, schemas: SchemaMetadata[] | null, hasDirectives: boolean): void;
/**
