 ...
 */
export declare const setInjectorProfiler: (injectorProfiler: InjectorProfiler | null) => void;
/**
 ...
 */
export declare function emitInjectEvent(token: Type<unknown>, value: unknown, flags: InjectFlags): void;
