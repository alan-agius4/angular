...
function migrateRoute(element, route, typeChecker, reflector, tracker) {
  ...
  const componentClassName =
    componentDeclaration.name && ts__default['default'].isIdentifier(componentDeclaration.name)
  ...
  const isDefaultExport =
    componentDeclaration.modifiers?.some(
      (x) => x.kind === ts__default['default'].SyntaxKind.DefaultKeyword,
    ) ?? false;
...
function createLoadComponentPropertyAssignment(
  ...
  return ts__default['default'].factory.createPropertyAssignment(
    'loadComponent',
    ts__default['default'].factory.createArrowFunction(
      ...
      isDefaultExport
        ...
        : ts__default['default'].factory.createCallExpression(
            ...
            ts__default['default'].factory.createPropertyAccessExpression(
...
const createImportCallExpression = (componentImportPath) =>
  ts__default['default'].factory.createCallExpression(
    ts__default['default'].factory.createIdentifier('import'),
    undefined,
...
const createImportThenCallExpression = (componentDeclarationName) =>
  ts__default['default'].factory.createArrowFunction(
    ...
    undefined,
    [
      ts__default['default'].factory.createParameterDeclaration(
        undefined,
        undefined,
        'm',
        undefined,
    ...
    ts__default['default'].factory.createPropertyAccessExpression(
      ts__default['default'].factory.createIdentifier('m'),
      componentDeclarationName,
    ),
  );
