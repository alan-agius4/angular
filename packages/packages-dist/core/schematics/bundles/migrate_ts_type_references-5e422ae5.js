...
(function (FieldIncompatibilityReason) {
  FieldIncompatibilityReason[(FieldIncompatibilityReason['OverriddenByDerivedClass'] = 1)] =
    'OverriddenByDerivedClass';
  FieldIncompatibilityReason[
    (FieldIncompatibilityReason['RedeclaredViaDerivedClassInputsArray'] = 2)
  ] = 'RedeclaredViaDerivedClassInputsArray';
  FieldIncompatibilityReason[(FieldIncompatibilityReason['TypeConflictWithBaseClass'] = 3)] =
    'TypeConflictWithBaseClass';
  FieldIncompatibilityReason[(FieldIncompatibilityReason['ParentIsIncompatible'] = 4)] =
    'ParentIsIncompatible';
  FieldIncompatibilityReason[(FieldIncompatibilityReason['DerivedIsIncompatible'] = 5)] =
    'DerivedIsIncompatible';
  FieldIncompatibilityReason[(FieldIncompatibilityReason['SpyOnThatOverwritesField'] = 6)] =
    'SpyOnThatOverwritesField';
  FieldIncompatibilityReason[
    (FieldIncompatibilityReason['PotentiallyNarrowedInTemplateButNoSupportYet'] = 7)
  ] = 'PotentiallyNarrowedInTemplateButNoSupportYet';
  FieldIncompatibilityReason[
    (FieldIncompatibilityReason['SignalIncompatibleWithHostBinding'] = 8)
  ] = 'SignalIncompatibleWithHostBinding';
  FieldIncompatibilityReason[
    (FieldIncompatibilityReason['SignalInput__RequiredButNoGoodExplicitTypeExtractable'] = 9)
  ] = 'SignalInput__RequiredButNoGoodExplicitTypeExtractable';
  FieldIncompatibilityReason[
    (FieldIncompatibilityReason['SignalInput__QuestionMarkButNoGoodExplicitTypeExtractable'] = 10)
  ] = 'SignalInput__QuestionMarkButNoGoodExplicitTypeExtractable';
  FieldIncompatibilityReason[
    (FieldIncompatibilityReason['SignalQueries__QueryListProblematicFieldAccessed'] = 11)
  ] = 'SignalQueries__QueryListProblematicFieldAccessed';
  FieldIncompatibilityReason[
    (FieldIncompatibilityReason['SignalQueries__IncompatibleMultiUnionType'] = 12)
  ] = 'SignalQueries__IncompatibleMultiUnionType';
  FieldIncompatibilityReason[(FieldIncompatibilityReason['WriteAssignment'] = 13)] =
    'WriteAssignment';
  FieldIncompatibilityReason[(FieldIncompatibilityReason['Accessor'] = 14)] = 'Accessor';
  FieldIncompatibilityReason[(FieldIncompatibilityReason['OutsideOfMigrationScope'] = 15)] =
    'OutsideOfMigrationScope';
  FieldIncompatibilityReason[(FieldIncompatibilityReason['SkippedViaConfigFilter'] = 16)] =
...
(function (ClassIncompatibilityReason) {
  ClassIncompatibilityReason[(ClassIncompatibilityReason['ClassManuallyInstantiated'] = 0)] =
    'ClassManuallyInstantiated';
  ClassIncompatibilityReason[
    (ClassIncompatibilityReason['OwningClassReferencedInClassProperty'] = 1)
...
function checkIncompatiblePatterns(
  ...
  for (const knownFieldClass of getAllClassesWithKnownFields()) {
    ...
    assert__default['default'](
      ts__default['default'].isClassDeclaration(classSymbol.valueDeclaration),
  ...
  const visitor = (node) => {
    ...
    if (
      ts__default['default'].isNewExpression(node) &&
      ts__default['default'].isIdentifier(checker.unwrapExpression(node.expression))
    ) {
      ...
      if (newTarget && inputClassSymbolsToClass.has(newTarget)) {
        fields.markClassIncompatible(
          ...
          exports.ClassIncompatibilityReason.ClassManuallyInstantiated,
        );
      }
    }
    ...
    problematicReferencesCheck: if (
      ...
      if (newTarget && inputClassSymbolsToClass.has(newTarget)) {
        ...
        fields.markClassIncompatible(
          inputClassSymbolsToClass.get(newTarget),
          exports.ClassIncompatibilityReason.OwningClassReferencedInClassProperty,
        );
      }
    }
  };
...
class InheritanceGraph {
  ...
  expensivePopulate(files) {
    for (const file of files) {
      const visitor = (node) => {
        if (
          (ts__default['default'].isClassLike(node) ||
          ...
          const parents = heritageTypes
            ...
            .filter(
              (d) =>
                d !== undefined &&
                (ts__default['default'].isClassLike(d) ||
...
function checkInheritanceOfKnownFields(inheritanceGraph, metaRegistry, fields, opts) {
  const allInputClasses = Array.from(inheritanceGraph.allClassesInInheritance).filter(
    (t) => ts__default['default'].isClassDeclaration(t) && opts.isClassWithKnownFields(t),
  );
  for (const inputClass of allInputClasses) {
    ...
    assert__default['default'](
      ts__default['default'].isClassDeclaration(inputClass),
      'Expected input graph node to be always a class.',
    );
    ...
    if (metaRegistry !== null) {
      for (const derivedClasses of inheritanceGraph.traceDerivedClasses(inputClass)) {
        const derivedMeta =
          ts__default['default'].isClassDeclaration(derivedClasses) &&
          derivedClasses.name !== undefined
    ...
    inputCheck: for (const fieldDescr of classFields) {
      ...
      if (
        ...
        (ts__default['default'].isIdentifier(fieldDescr.node.name) ||
          ts__default['default'].isStringLiteralLike(fieldDescr.node.name)) &&
...
function removeFromUnionIfPossible(union, filter) {
  ...
  return ts__default['default'].factory.updateUnionTypeNode(
    union,
    ts__default['default'].factory.createNodeArray(filtered),
  );
}
...
function insertPrecedingLine(node, info, text) {
  ...
  return new project_paths.Replacement(
    project_paths.projectFile(node.getSourceFile(), info),
    new project_paths.TextUpdate({
...
function getMessageForFieldIncompatibility(reason, fieldName) {
  switch (reason) {
    ...
    case exports.FieldIncompatibilityReason
      .SignalInput__QuestionMarkButNoGoodExplicitTypeExtractable:
      return {
  ...
  return (
    ...
    !(
      ...
      (ts__default['default'].SymbolFlags.Value |
        ts__default['default'].SymbolFlags.ExportValue |
        ts__default['default'].SymbolFlags.Alias)
    )
  );
}
/**
...
function createNewBlockToInsertVariable(node, file, toInsert) {
  ...
  const spacingNode =
    ts__default['default'].findAncestor(node, ts__default['default'].isStatement) ?? node.parent;
  const {character} = ts__default['default'].getLineAndCharacterOfPosition(
    sf,
    spacingNode.getStart(),
  );
  const blockSpace = ' '.repeat(character);
  const contentSpace = ' '.repeat(character + 2);
  return [
    // Delete leading whitespace of the concise body.
    new project_paths.Replacement(
      file,
      new project_paths.TextUpdate({
...
function migrateBindingElementInputReference(
  ...
  for (const reference of tsReferencesInBindingElements) {
    ...
    assert__default['default'](
      !ts__default['default'].isObjectBindingPattern(inputFieldName) &&
        !ts__default['default'].isArrayBindingPattern(inputFieldName),
    ...
    const useTmpNameForInputField =
      !ts__default['default'].isObjectBindingPattern(bindingElement.name) ||
      !ts__default['default'].isIdentifier(inputFieldName);
    ...
    const exposedName = useTmpNameForInputField
      ...
      : inputFieldName;
    const newBindingToAccessInputField = ts__default['default'].factory.updateBindingElement(
      bindingElement,
...
function insertTemporaryVariableForBindingElement(expansionDecl, file, toInsert) {
  ...
  // below.
  if (
    ts__default['default'].isVariableDeclaration(expansionDecl) &&
    ts__default['default'].isVariableDeclarationList(parent)
  ) {
    const leadingSpaceCount = ts__default['default'].getLineAndCharacterOfPosition(
      sf,
      parent.getStart(),
    ).character;
  ...
  if (bodyBlock !== null) {
    ...
    const leadingSpaceCount =
      ts__default['default'].getLineAndCharacterOfPosition(sf, spaceReferenceNode.getStart())
        .character + spaceOffset;
    const leadingSpace = ' '.repeat(leadingSpaceCount);
    return [
      new project_paths.Replacement(
        file,
  ...
  if (
    ts__default['default'].isArrowFunction(parent) &&
    !ts__default['default'].isBlock(parent.body)
  ) {
...
function isControlFlowBoundary(node) {
  return (
    (ts__default['default'].isFunctionLike(node) &&
...
function getImmediatelyInvokedFunctionExpression(func) {
  if (
    func.kind === ts__default['default'].SyntaxKind.FunctionExpression ||
    func.kind === ts__default['default'].SyntaxKind.ArrowFunction
  ) {
    let prev = func;
    ...
    if (
      parent.kind === ts__default['default'].SyntaxKind.CallExpression &&
...
function connectSharedReferences(result, flowPartners, refId) {
  ...
  assert__default['default'](
    earliestPartnerId !== null,
    'Expected an earliest partner to be found.',
  );
...
function isPotentialInsertionAncestor(node) {
  ...
  // to a block.
  return (
    ts__default['default'].isSourceFile(node) ||
    ts__default['default'].isBlock(node) ||
    ts__default['default'].isArrowFunction(node) ||
    ts__default['default'].isClassLike(node)
  );
}
...
function findSimilarReferenceNode(
  ...
  return (
    ts__default['default'].forEachChild(start, function visitChild(node) {
...
function isLexicalSameReference(checker, sharePartner, reference) {
  ...
  if (
    !ts__default['default'].isPropertyAccessExpression(aParent) &&
    !ts__default['default'].isElementAccessExpression(aParent)
  ) {
  ...
  for (const reference of tsReferencesWithNarrowing.values()) {
    ...
    for (const {id, originalNode, recommendedNode} of controlFlowResult) {
      ...
      if (recommendedNode === 'preserve') {
        ...
        replacements.push(
          new project_paths.Replacement(
            project_paths.projectFile(sf, info),
            new project_paths.TextUpdate({
      ...
      if (
        ...
        const leadingSpace = ts__default['default'].getLineAndCharacterOfPosition(
          sf,
...
function migrateTypeScriptTypeReferences(host, references, importManager, info) {
  ...
  for (const reference of references) {
    ...
    if (reference.isPartialReference && reference.isPartOfCatalystFile) {
      assert__default['default'](
        reference.from.node.typeArguments,
        'Expected type arguments for partial reference.',
      );
      assert__default['default'](
        reference.from.node.typeArguments.length === 1,
        'Expected an argument for reference.',
      );
